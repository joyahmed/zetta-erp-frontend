			...
			{tableData && tableData.length > 0 ? (
				tableData.map((item, index) => (
					...
					>
						...
						<TableCell text={item.total_days ?? 'N/A'} />
						<TableCell text={item.leave_type || 'N/A'} />
						<TableCell text={item.reason || 'N/A'} />
						<TableCell text={item.status || 'Pending'} />
					</tr>
				))
			) : (
				<tr>
...
export default LeaveRequestTableBody;
